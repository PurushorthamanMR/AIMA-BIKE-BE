# AimaBike POS Backend - Node.js Version
...
- MySQL running; create database (e.g. `aima_bike_db`) if needed
...
- Optional: load sample data **after** first server run:  
  `mysql -u root -p aima_bike_db < migrations/sample_data.sql`  
